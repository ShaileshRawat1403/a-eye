...
It is intended for A-Eye developers and A-Eye itself when reasoning about future exit/shutdown
changes.
...
A-Eye has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
