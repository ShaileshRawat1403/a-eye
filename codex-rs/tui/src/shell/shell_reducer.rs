...
use super::shell_effects::UiEffect;
use super::shell_state::ARTIFACT_SCHEMA_V1;
use super::shell_state::ApprovalGateRequirement;
use super::shell_state::ApprovalRiskClass;
use super::shell_state::DiffArtifact;
use super::shell_state::DiffFile;
use super::shell_state::DiffFileStatus;
use super::shell_state::DiffHunk;
use super::shell_state::DiffLine;
use super::shell_state::DiffLineKind;
...
use super::shell_state::ShellOverlay;
...
use super::ui_action::PaletteCommand;
use super::ui_action::RuntimeAction;
use super::ui_action::RuntimeFlag;
use super::ui_action::ShellAction;
use super::ui_action::UserAction;
use super::ui_action::filtered_palette_indices;

pub(crate) fn reduce(state: &mut ShellState, action: ShellAction) -> Vec<UiEffect> {
    match action {
...
fn reduce_user(state: &mut ShellState, action: UserAction) -> Vec<UiEffect> {
    match action {
...
fn command_to_effects(command: PaletteCommand) -> Vec<UiEffect> {
    match command {
        ...
        PaletteCommand::OpenSkills => {
            vec![UiEffect::EmitAppEvent(Box::new(AppEvent::OpenSkillsList))]
        }
        PaletteCommand::StartNewSession => {
            vec![UiEffect::EmitAppEvent(Box::new(AppEvent::NewSession))]
        }
