...
use aeye_mcp_types::RequestId;
use aeye_mcp_types::Resource as McpResource;
use aeye_mcp_types::ResourceTemplate as McpResourceTemplate;
use aeye_mcp_types::Tool as McpTool;
