...
use aeye_utils_image::load_and_resize_to_fit;
use aeye_mcp_types::CallToolResult;
use aeye_mcp_types::ContentBlock;
...
use aeye_execpolicy::Policy;
use aeye_git::GhostCommit;
use aeye_utils_image::error::ImageProcessingError;
...
mod tests {
    ...
    use aeye_mcp_types::ImageContent;
    use aeye_mcp_types::TextContent;
